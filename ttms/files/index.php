...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">TIME TABLE MANAGEMENT SYSTEM, INFORMATION SCIENCE DEPARTMENT</h3>
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/madhura.jpeg" class="img-rounded"/>
                    <h3 align="center">Prof. Madhura J</h3>
                    <hr/>
                    <h4 align="center">Associate professor<br/>Information Science Engineering Department</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    <img src="assets\img\faculty\lathap.jpeg" class="img-rounded"/>
                    <h3 align="center">PROF. Latha AP</h3>
                    <hr/>
                    <h4 align="center">Associate professor<br/> Information Science Engineering Department</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="assets\img\faculty\radh.jpeg" class="img-rounded"/>
                    <h3 align="center">PROF.Radhika TV</h3>
                    <hr/>
                    <h4 align="center">Associate professor<br/>Information Science Engineering Department</h4>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4><strong>Email: </strong>dsce.com</h4>
            </div>
